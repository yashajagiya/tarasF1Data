        ...
        for event in schedule:
            ...
            if session_dates and race_date and fp1_info and fp1_info.get('date'):
                ...
                if min_date <= target_date <= race_date:
                    ...
                    print(f"Found active race weekend FP1 session ({fp1_info.get('date')}): {url}")
